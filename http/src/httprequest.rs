...
pub struct HttpRequest{
    ...
    pub hearders: HashMap<String, String>,
    pub msg_body: String, 
}
...
impl From<String> for HttpRequest {
    fn from (req: String) -> Self {
        ...
        let mut prased_headers = HashMap::new();
        ...
        for line in req.lines() {
            if line.contains("HTTP") {
                ...
                prased_headers.insert(key, value);
            } else if line.len() == 0 {
...
mod tests {
    ...
    fn test_read_http() {
        ...
        assert_eq!(headers_expected, req.hearders);
